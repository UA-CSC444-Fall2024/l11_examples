...
// `colorScale', as defined on line 155
//
...
// Add the svg element
let svg = d3.selectAll("#div1").append("svg")
...
function colorScale6(d) {
  let colorScale = d3.scaleQuantize(d3.schemePuOr[4]) //4 could be any number 3...9
    .domain([dMin,dMax])
...
//this trickier lets us keep the name of the variable 
//around to set the chart title
let colorScaleObj = { colorScale1 }; //CHANGE ME TO SELECT A DIFFERENT COLOR SCALE
let colorScale = colorScaleObj[Object.keys(colorScaleObj)[0]]
...
svg.append("g")
   ...
   .append("text")
   .text("Circles colored using \"" + Object.keys(colorScaleObj)[0] + "\"")
